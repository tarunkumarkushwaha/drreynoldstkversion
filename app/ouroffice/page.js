        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <div>
            ...
            <p className="mt-6 max-w-md text-[14px] leading-relaxed text-black/65 sm:text-[18px]">
              My {siteInfo.city} office is a quiet, private space with
              natural light and a comfortable, uncluttered environment —
              built to feel grounding the moment you walk in. Clients often
              tell me the space itself helps them settle before we&rsquo;ve
